...
const RelatedList = ({defaultData, productList, starRating/*, colorScheme={colorScheme}*/}) => {
    ...
    <div id='related-card-container'>
      ...
      <div id='related-card-list'>
        {productList.map((product) => {
          return <RelatedListItem key={product.id} itemId={product.id} product={product} defaultData={defaultData} starRating={starRating} /*colorScheme={colorScheme}*//>
        })}
      </div>
